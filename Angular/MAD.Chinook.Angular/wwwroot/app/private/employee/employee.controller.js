(function () {
    ...
    function employeeController(dataService, configService, $state, $scope) {
        ...
        function totalRecords() {
            dataService.getData(apiUrl + '/employee/count').then(function (result) {
        ...
        function getEmployee(employeeId) {
            vm.employee = null;
            dataService.getData(apiUrl + '/employee/' + employeeId).then(function (result) {
        ...
        function updateEmployee() {
            ...
            dataService.putData(apiUrl + '/employee', vm.employee).then(function (result) {
                vm.employee = {};
        ...
        function createEmployee() {
            if (!vm.employee) return;
            dataService.postData(apiUrl + '/employee', vm.employee).then(function (result) {
        ...
        function deleteEmployee() {
            dataService.deleteData(apiUrl + '/employee/' + vm.employee.employeeId).then(function (result) {
                getPageRecords(vm.currentPage);
                closeModal();
            },
                function (error) {
