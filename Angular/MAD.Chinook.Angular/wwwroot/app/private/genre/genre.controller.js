(function () {
    ...
    function genreController(dataService, configService, $state, $scope) {
        ...
        function totalRecords() {
            dataService.getData(apiUrl + '/genre/count').then(function (result) {
        ...
        function getGenre(genreId) {
            vm.genre = null;
            dataService.getData(apiUrl + '/genre/' + genreId).then(function (result) {
        ...
        function updateGenre() {
            if (!vm.genre) return;
            dataService.putData(apiUrl + '/genre', vm.genre).then(function (result) {
                vm.genre = {};
        ...
        function createGenre() {
            if (!vm.genre) return;
            dataService.postData(apiUrl + '/genre', vm.genre).then(function (result) {
        ...
        function deleteGenre() {
            dataService.deleteData(apiUrl + '/genre/' + vm.genre.genreId).then(function (result) {
                getPageRecords(vm.currentPage);
                closeModal();
            },
                function (error) {
