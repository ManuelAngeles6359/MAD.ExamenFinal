(function () {
    ...
    function invoiceController(dataService, configService, $state, $scope) {
        ...
        function totalRecords() {
            dataService.getData(apiUrl + '/invoice/count').then(function (result) {
        ...
        function getInvoice(invoiceId) {
            vm.invoice = null;
            dataService.getData(apiUrl + '/invoice/' + invoiceId).then(function (result) {
        ...
        function updateInvoice() {
            ...
            dataService.putData(apiUrl + '/invoice', vm.invoice).then(function (result) {
                vm.invoice = {};
        ...
        function createInvoice() {
            if (!vm.invoice) return;
            dataService.postData(apiUrl + '/invoice', vm.invoice).then(function (result) {
        ...
        function deleteInvoice() {
            dataService.deleteData(apiUrl + '/invoice/' + vm.invoice.invoiceId).then(function (result) {
                getPageRecords(vm.currentPage);
                closeModal();
            },
                function (error) {
