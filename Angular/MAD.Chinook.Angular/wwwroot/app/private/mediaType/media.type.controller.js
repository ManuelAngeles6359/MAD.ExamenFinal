(function () {
    'use strict';
    angular.module('app').controller('mediaTypeController', mediaTypeController);
    ...
    function mediaTypeController(dataService, configService, $state, $scope) {
        ...
        function totalRecords() {
            dataService.getData(apiUrl + '/mediaType/count').then(function (result) {
        ...
        function getMediaType(mediaTypeId) {
            vm.mediaType = null;
            dataService.getData(apiUrl + '/mediaType/' + mediaTypeId).then(function (result) {
        ...
        function updateMediaType() {
            ...
            dataService.putData(apiUrl + '/mediaType', vm.mediaType).then(function (result) {
                vm.mediaType = {};
        ...
        function createMediaType() {
            if (!vm.mediaType) return;
            dataService.postData(apiUrl + '/mediaType', vm.mediaType).then(function (result) {
        ...
        function deleteMediaType() {
            dataService.deleteData(apiUrl + '/mediaType/' + vm.mediaType.mediaTypeId).then(function (result) {
                getPageRecords(vm.currentPage);
                closeModal();
            },
                function (error) {
